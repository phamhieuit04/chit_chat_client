    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-transparent backdrop-blur-sm">
        <div
            ...
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold">Soạn tin</h1>
            ...
            <ul
                class="overflow-scroll flex flex-col gap-4 h-96 overflow-x-hidden scrollbar scrollbar-thumb-[#3e3e3e] scrollbar-track-transparent pr-2">
